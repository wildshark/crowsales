...
function SalesInvoices($conn){
    ...
    if((!isset($data))||($data == false)){
        ...
        foreach ($data as $r){
            ...
            <td>$paid</td>
            <td>
                <a href='?main=invoice&ui=main&id=$id&token=$token' class='btn btn-outline-primary'>View</button>
            </td>
        </tr>";
        }
    }
...
function InvoiceSalesData($conn){
    ...
    if((!isset($data))||($data == false)){
        ...
        foreach ($data as $r){
            ...
            <td>$amount</td>
            <td>
                <a href='?submit=invoice-item-delete&id=$id' class='text-danger'> Delete</a>
            </td>
        </tr>";
        }
    }
